...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=3):
    ...
    # 确保维度和类型正确
    img = img.transpose(2, 0, 1).astype('uint8')
    img = img / 255.
    ...
    # print("seqs_alpha", seqs_alpha.shape)
...
if __name__ == '__main__':
    ...
    args.img = 'caption data/667626_18933d713e.jpg'
    args.word_map = 'caption data/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json'
    args.beam_size = 5
    args.smooth = True  # 或 False，取决于你的需要
